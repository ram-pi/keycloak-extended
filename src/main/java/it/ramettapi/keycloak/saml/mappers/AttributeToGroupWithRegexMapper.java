...
public class AttributeToGroupWithRegexMapper extends AbstractIdentityProviderMapper implements IdentityProviderMapper {

	// logger ------------------------------------------------
	private static final Logger logger = Logger.getLogger(AttributeToGroupWithRegexMapper.class);
	...
	public static final String PROVIDER_ID = "saml-attribute-to-group-with-regex-mapper";
	...
	static {
        ...
        property.setHelpText("Value the attribute must contains. If the attribute is a list, then the value must be contained in the list.");
        property.setType(ProviderConfigProperty.STRING_TYPE);
        configProperties.add(property);
        property = new ProviderConfigProperty();
	...
	public String getDisplayType() {
		return "SAML Attribute to Group With Regex Mapper";
	}
        ...
        for (AttributeStatementType statement : assertion.getAttributeStatements()) {
            for (AttributeStatementType.ASTChoiceType choice : statement.getAttributes()) {
                ...
                for (Object val : attr.getAttributeValue()) {
                    if (val instanceof String && String.valueOf(val).contains(desiredValue)) return true;
                }
            }
        }
        return false;
